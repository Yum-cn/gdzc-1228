...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="typeGridTree" title="" actionUrl="systemController.do?typeGroupGrid&typeGroupId=402881f363521dc30163521f01a90002" idField="id" treegrid="false" pagination="false"  sortOrder="desc" sortName="id" onLoadSuccess="loadSuccess">
            <t:dgCol title="common.code" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="类别名称" field="typegroupname" width="100" query="true"></t:dgCol>
            <t:dgCol title="类别code" field="typegroupcode" width="100" treefield="code"></t:dgCol>
            <t:dgCol title="common.operation" field="opt" width="100"></t:dgCol>
            ...
            <t:dgToolBar title="录入资产类别" langArg="lang.dictionary.type" icon="icon-add" url="systemController.do?aouTypeGroup" funname="add"></t:dgToolBar>
            <%--<t:dgToolBar title="common.add.param" langArg="lang.dictionary.value" icon="icon-add" funname="typeGridTree_AddType"></t:dgToolBar>--%>
            <t:dgToolBar title="编辑资产类别" icon="icon-edit" url="systemController.do?aouTypeGroup" funname="update"></t:dgToolBar>
        </t:datagrid>
    </div>
</div>
