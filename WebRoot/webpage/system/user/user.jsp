...
//            var orgIds = $("#orgSelect").combobox("getValues");
		...
		function readCardNo(){
			$.post("userController.do?readCardNo",{suggest:''},function(result){
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			<td align="right" nowrap><label class="Validform_label">门禁卡号: </label></td>
			<td class="value">
                <input class="inputxt" name="cardNo" id="cardNo" value="${user.cardNo}"  ignore="ignore"><input type="button" name="Submit" value="读取卡号" onclick="readCardNo()"/>
