...
<%@page import="org.qihuasoft.core.util.SysThemesUtil,org.jeecgframework.core.enums.SysThemesEnum"%> 
<%@include file="/context/mytags.jsp"%>
<!DOCTYPE html>
<%
	String lang = org.qihuasoft.core.util.BrowserUtils.getBrowserLanguage(request);
