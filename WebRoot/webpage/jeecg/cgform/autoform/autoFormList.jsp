...
function addbytab() {
	    ...
	    location.href="autoFormController.do?goAdd";
...
var rows = $("#autoFormList").datagrid("getSelections");
	...
	location.href="autoFormController.do?goUpdate&id="+id;
...
function dbconfig(id){
	...
	location.href="autoFormDbController.do?autoFormDb&autoFormId="+id;
}
