...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  ...
  <div class="layui-tab-content" style="height: 100px;">
    <div class="layui-tab-item layui-show">
		<form name="form1" id="form1" method="post" action="scheduleController.do?doAdd" class="layui-form layui-form-pane ">
		<div class="formbody">
		  <ul class="forminfo">
		    <li>
		      <label class="layui-form-label">日程内容:</label>
		      	<input id="content" name="content" type="text" class="dfinput" datatype="*" class="layui-input"/>
		      <i class="Validform_checktip"></i>
		    </li>
		    <li>
		      <label class="from-label-title">开始时间:</label>
		      	<input id="startTime" name="startTime" type="text" class="dfinput" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*"/>
		      <i class="Validform_checktip"></i>
		    </li>
		    <li>
		      <label class="from-label-title">结束时间:</label>
		      	<input id="endTime" name="endTime" type="text" class="dfinput" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*"/>
		      <i class="Validform_checktip"></i>
		    </li>
		    <li>
		      <label>&nbsp;</label>
