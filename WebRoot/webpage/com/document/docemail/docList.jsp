...
<div id="container">
    ...
    <div id="bd">
    	...
    	<form name="searchForm" id="searchForm" method="post" action="docMyFileController.do?list" class="layui-form layui-form-pane">
          ...
          <button class="layui-btn" onclick="add('docMyFileController.do?goAdd')"><i class="layui-icon"></i> 添加</button>
          <button class="layui-btn" onclick="deleteNewStyleALLSelect('提示','docMyFileController.do?doBatchDel','')"><i class="layui-icon">&#xe640;</i> 批量删除</button>
          <form name="searchForm" id="searchForm" method="post" action="docMyFileController.do?list" >
            <div class="table">
					  ...
					  <table class="layui-table">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
					        ...
					        <td><a href="docMyFileController.do?goUpdate&id=${resultList.id}" class="tablelink">修改</a>  <a href="javascript:void(0);" onclick="deleteDialog('提示','docMyFileController.do?doDel','${resultList.id}')" class="tablelink" > 删除</a></td>
					      </tr>
					      </c:forEach>
