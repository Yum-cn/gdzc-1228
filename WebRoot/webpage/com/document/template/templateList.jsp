...
<div class="rightinfo">
<form name="searchForm" id="searchForm" method="post" action="templateController.do?list">
<div id="container">
	<div id="hd"></div>
    <div id="bd">
    	<div id="main">
        	<div class="search-box ue-clear">
            	<div class="search-area">
                    <div class="kv-item">
		                        <label style="width:120px;">&nbsp;&nbsp;&nbsp;&nbsp;格式文档标题:</label>
		                        <div class="kv-item-content">
							      	<input id="title" name="title" type="text" type="text" value="${title}"/>
		                        </div>
                        <div class="kv-item-content">
            ...
            <div class="table">
            	<div class="opt ue-clear">
                	...
                	<span class="optarea">
                        <a href="javascript:;" onclick="add('templateController.do?goAdd')" class="add">
                            <i class="icon"></i>
                            <span class="text">添加格式文档</span>
                        </a>
                        <a href="javascript:;"  onclick="deleteNewStyleALLSelect('提示','templateController.do?doBatchDel','')" class="delete">
                            <i class="icon"></i>
					  ...
					  <table class="tablelist">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
					        ...
					        <td><a href="templateController.do?goUpdate&id=${resultList.id}" class="tablelink">修改</a>  <a href="javascript:void(0);" onclick="deleteDialog('提示','templateController.do?doDel','${resultList.id}')" class="tablelink" > 删除</a></td>
					      </tr>
					      </c:forEach>
				  ...
				  %>
				    ...
				    <ul class="paginList">
				    			<%
										if(currentPage>1){
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('templateController.do?list&str_currentPage=<%=currentPage-1 %>')"  style="width:76px;text-decoration: none;"><span class="pagepre"> < 上一页</span></a></li>
								<%
										}else{
								%>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('templateController.do?list&str_currentPage=<%=i+1 %>')"><%=i+1 %></a></li>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('templateController.do?list&str_currentPage=<%=currentPage+1 %>')"  style="width:76px;text-decoration: none;"><span class="pagenxt">下一页 > </span></a></li>
								<%
										}else{
								%>
...
<script type="text/javascript">
	...
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'templateController.do?upload', "templateList");
	}
	
	//导出
	function ExportXls() {
		JeecgExcelExport("templateController.do?exportXls","templateList");
	}
</script>
</body>
</html>
