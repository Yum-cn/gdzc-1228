...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  ...
  <div class="layui-tab-content" style="height: 100px;">
    <div class="layui-tab-item layui-show">
		<form name="form1" id="form1" method="post" action="docLibraryCommonController.do?doAdd">
		<div class="formbody">
		  <ul class="forminfo">
		    <li>
		    ...
		    <li>
		      <label class="from-label-title">上传时间:</label>
		      	<input id="uploadTime" name="uploadTime" type="text" class="dfinput" class="Wdate" onClick="WdatePicker()" datatype="*"/>
		      <i class="Validform_checktip"></i>
		    </li>
		    <li>
