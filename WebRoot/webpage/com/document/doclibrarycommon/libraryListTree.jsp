...
<script type="text/javascript" src="${pageContext.request.contextPath}/plug-in/ztree/js/jquery.ztree.core-3.5.min.js"></script>
  ...
  <!--
	...
	var zNodes =[
		{id:1, pId:0, name:"教育文档库", open:true, url:"${webRoot}/docLibraryCommonController.do?list&pId=1",target:"testIframe"},
		<c:forEach items="${resultList}" var="resultList">
			{id:'${resultList.id}', pId:'${resultList.pId}', name:"${resultList.folderName}", url:"${webRoot}/docLibraryCommonController.do?list&pId=${resultList.id}",target:"testIframe"},
		</c:forEach>
...
<table border=0 align=left>
	<tr>
		...
		<td width="90%" align="left" valign="top"><iframe id="testIframe" name="testIframe" frameborder=0 scrolling="auto" src="${webRoot }/docLibraryCommonController.do?list"></iframe></td>
	</tr>
</table>
