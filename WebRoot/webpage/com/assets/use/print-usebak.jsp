...
<table cellpadding="0" cellspacing="0"style="width: 60%;margin:auto">
    <tr>
      <td height="50" colspan="10" ><div align="center" style="font-family:'宋体'; font-size:22pt">出库领用单</div></td>
    </tr>
    <tr>
    ...
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:仿宋;font-size:16pt">领用单号</div></td>
    ...
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:仿宋;font-size:16pt">使用人</div></td>
      <td colspan="7" style="border:solid 1px black;border-collapse:collapse"><div align="center"style="font-family:仿宋;font-size:16pt">${se.useUser}</div></td>
    </tr>
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:仿宋;font-size:16pt">使用室</div></td>
      <td colspan="7" style="border:solid 1px black;border-collapse:collapse"><div align="center"style="font-family:仿宋;font-size:16pt">${se.address}</div></td>
    </tr>
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:仿宋;font-size:16pt">领用时间</div></td>
      <td colspan="7" style="border:solid 1px black;border-collapse:collapse"><div align="center"style="font-family:仿宋;font-size:16pt"><fmt:formatDate value="${se.useTime}" pattern="yyyy-MM-dd"/></div></td>
    </tr>
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td colspan="3" style="border:solid 1px black;border-collapse:collapse"><p align="center" style="font-family:仿宋;font-size:16pt">领用明细</p></td>
