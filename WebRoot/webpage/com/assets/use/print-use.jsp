...
<table cellpadding="0" cellspacing="0"style="width: 90%;margin:auto">
    <tr>
      <td height="50" colspan="10" ><div align="center" style="font-family:'黑体'; font-size:22pt">出库领用单</div></td>
    </tr>
    <tr>
    ...
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:黑体;font-size:16pt">使&nbsp;用&nbsp;人：</div></td>
      <td colspan="7" style="border:solid 1px black;border-collapse:collapse"><div align="center"style="font-family:黑体;font-size:16pt">${se.useUser}</div></td>
    </tr>
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:黑体;font-size:16pt">使&nbsp;用&nbsp;室：</div></td>
      <td colspan="7" style="border:solid 1px black;border-collapse:collapse"><div align="center"style="font-family:黑体;font-size:16pt">${se.address}</div></td>
    </tr>
    <tr style="border:solid 1px black;border-collapse:collapse">
    ...
    <tr  height="50" style="border:solid 1px black;border-collapse:collapse">
      <td colspan="3" style="border:solid 1px black;border-collapse:collapse"><p align="center" style="font-family:黑体;font-size:16pt">领用明细：</p></td>
