...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  ...
  <div class="layui-tab-content">
    <div class="layui-tab-item layui-show">
		<form name="form1" id="form1" method="post" action="scrapController.do?doAdd">
		<div class="formbody">
		  <ul class="forminfo">
		    <li>
		    ...
		    <li>
		      <label class="from-label-title">报废时间:</label>
		      	<input id="scrapTime" name="scrapTime" type="text" class="dfinput" class="Wdate" onClick="WdatePicker()" datatype="*"/>
		      <i class="Validform_checktip"></i>
		    </li>
		    <li>
		      <label class="from-label-title">报废原因:</label>
		      	<input id="reason" name="reason" type="text" class="dfinput" datatype="*"/>
		      <i class="Validform_checktip"></i>
		    </li>
				<li>
...
<script type="text/javascript">
	...
	function choose_402881f3635381d50163539e13530004() {
		var url = 'storeController.do?selectList';
