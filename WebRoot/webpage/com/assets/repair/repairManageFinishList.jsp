					  ...
					  <table class="layui-table">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
					        ...
					        <td>
					        <c:if test="${resultList.status=='approvaled'}"><a href="#" class="tablelink" onclick="finish('${resultList.id }')" >故障消除</a></c:if>
...
<script type="text/javascript">
    ...
    function finish(id){
        ...
        $.dialog.confirm('该资产将完成维修，确认提交吗？', function(){
            $.post("repairManageController.do?update",{id:id,status:'finish'},function(result){
                var jsonObj = JSON.parse(result);
                $.dialog.alert(jsonObj.msg?jsonObj.msg:"操作成功！");
                if(jsonObj.success){
                    window.location.href="repairManageController.do?list&queryStatus=manager";
                }
            });
        }, function(){
        });
