...
// 		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		...
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(38,126,180,20,"${se.oddNumbers}");
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(58,126,180,20,"${se.repairUser}");
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(78,126,180,20,"${se.reason}");
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(98,126,180,20,'<fmt:formatDate value="${se.repairTime}" pattern="yyyy-MM-dd"/>');
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
        LODOP.ADD_PRINT_TEXT(118,126,180,20,"${se.content}");
        
        LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
        LODOP.ADD_PRINT_TEXT(138,126,180,20,"${se.cost}");
        
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(158,126,180,20,'${se.remark}');
