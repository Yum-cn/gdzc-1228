					  ...
					  <table class="layui-table">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
									...
									<td style="font-weight: bold;"><c:if test="${resultList.status=='commit'}">待审核</c:if></td>

					        <td>
					        <a href="repairManageController.do?goUpdate&id=${resultList.id}&operateStatus=approval" class="tablelink">审核</a>  
					        </td>
					      </tr>
					      </c:forEach>
