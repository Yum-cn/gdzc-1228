...
// 		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		...
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(58,126,180,20,"${se.useUser}");
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(78,126,180,20,"${se.address}");
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(98,126,180,20,'<fmt:formatDate value="${se.allotTime}" pattern="yyyy-MM-dd"/>');
		
		LODOP.SET_PRINT_STYLEA(0,"TransColor","#FFFFFF");
		LODOP.ADD_PRINT_TEXT(118,126,180,20,'${se.remark}');
