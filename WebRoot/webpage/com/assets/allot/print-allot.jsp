...
<table cellpadding="0" cellspacing="0"style="width: 90%;margin:auto">
    ...
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse;width:25%;" ><div align="center" style="font-family:黑体;font-size:16pt">转移单号：</div></td>
    ...
    <tr style="border:solid 1px black;border-collapse:collapse">
      <td height="50" colspan="3" style="border:solid 1px black;border-collapse:collapse"><div align="center" style="font-family:黑体;font-size:16pt">转移时间：</div></td>
      <td colspan="7" style="border:solid 1px black;border-collapse:collapse"><div align="center"style="font-family:黑体;font-size:16pt"><fmt:formatDate value="${se.allotTime}" pattern="yyyy-MM-dd"/></div></td>
    </tr>
    <tr  height="50" style="border:solid 1px black;border-collapse:collapse">
      <td colspan="3" style="border:solid 1px black;border-collapse:collapse"><p align="center" style="font-family:黑体;font-size:16pt">转移明细：</p></td>
