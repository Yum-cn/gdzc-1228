...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="indicatorController.do?doAdd" tiptype="4">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr style="display:none;">
					...
					<td class="value">
					     	 <t:dictSelect field="pjdl" type="list"
									typeGroupCode="PJDL" defaultVal="${pjdl}" hasLabel="false"  title="德育评价项目"></t:dictSelect>     
				...
				<tr>
					...
					<td class="value">
					     	 <input id="name" name="name" type="text" class="inputxt" datatype="s1-33" >
				...
				<tr>
					...
					<td class="value">
					     	 <textarea id="discription" name="discription" style="width: 450px; height : 200px"></textarea>
							<span class="Validform_checktip"></span>
