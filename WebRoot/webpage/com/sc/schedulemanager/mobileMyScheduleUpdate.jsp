...
<input id="id" name="id" type="hidden" value="${scheduleManagerPage.id }">
    <div class="weui-cells_form">
      <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">日程标题</label></div>
        <div class="weui-cell__bd">
          <input class="weui-input" placeholder="请输入日程标题" name="title" value="${scheduleManagerPage.title }">
        </div>
      </div>
      <div class="weui-cell weui-cell_select weui-cell_select-after">
        <div class="weui-cell__hd">
          <label for="" class="weui-label">日程类型</label>
        </div>
        <div class="weui-cell__bd">
        	<t:dictSelect field="type" typeGroupCode="RCLX" hasLabel="false" extendJson="{'class':'weui-select'}" defaultVal="${scheduleManagerPage.type }"></t:dictSelect>

        </div>
      </div>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label for="time-format" class="weui-label">日程时间</label></div>
        <div class="weui-cell__bd">
          <input class="weui-input" id="time-format" type="text" name="timeString" value="${scheduleManagerPage.timeString }">
        </div>
      </div>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label for="name" class="weui-label">是否有课</label></div>
        <div class="weui-cell__bd">
          <input class="weui-input" name="isCourse" id="isCourse" type="text" value="${scheduleManagerPage.isCourse }">
        </div>
      </div>    
      <div class="weui-cell">
    ...
    <div class="weui-btn-area">
      <a class="weui-btn weui-btn_primary" href="javascript:" id="showTooltips" onclick="$('#form1').submit();">保存日程</a>
