    ...
    <div class="weui-cells_form">
      <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" placeholder="请输入日程标题" name="title">
        </div>
      </div>
      <div class="weui-cell weui-cell_select weui-cell_select-after">
        ...
        <div class="weui-cell__bd">
        	<t:dictSelect field="type" typeGroupCode="RCLX" hasLabel="false" extendJson="{'class':'weui-select'}"></t:dictSelect>
        </div>
      </div>
      <div class="weui-cell">
