    ...
    <div class="weui-cells_form">
      <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
          <input class="weui-input" placeholder="请输入事件标题" name="title" value="${scEventManagerPage.title }">
        </div>
      </div>
      <div class="weui-cell weui-cell_select weui-cell_select-after">
        ...
        <div class="weui-cell__bd">
			<t:dictSelect field="type" typeGroupCode="JJSJLX" hasLabel="false" extendJson="{'class':'weui-select'}" defaultVal="${scEventManagerPage.type }"></t:dictSelect>
        </div>
      </div>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label for="time-format" class="weui-label">事件时间</label></div>
        <div class="weui-cell__bd">
          <input class="weui-input" id="time-format" type="text" name="timestring" value="${scEventManagerPage.timestring }">
        </div>
      </div>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label for="name" class="weui-label">是否有课</label></div>
        <div class="weui-cell__bd">
          <input class="weui-input" name="isCourse" id="isCourse" type="text" value="${scEventManagerPage.isCourse }">
        </div>
      </div>       
      <div class="weui-cell">
