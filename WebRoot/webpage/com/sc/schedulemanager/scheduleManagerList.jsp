...
function viewwindow(id) {
	$.dialog({
		content: 'url:scheduleManagerController.do?goUpdate&id='+id,
		lock : true,
		width:800,
		height:350,
		title:"日程查看",
...
<div class="rightinfo">
<form name="searchForm" id="searchForm" method="post" action="scheduleManagerController.do?list">
<div id="container">
	<div id="hd"></div>
    <div id="bd">
    	<div id="main">
            	...
            	<div class="search-area">
                    <div class="kv-item">
		                        ...
		                        <div class="kv-item-content">
		                        	<t:dictSelect field="type" typeGroupCode="RCLX" hasLabel="false"></t:dictSelect>
		                        </div>
                    		    <label>&nbsp;&nbsp;&nbsp;&nbsp;所属人:</label>
		                        <div class="kv-item-content">
            ...
            <div class="table">
            	<div class="opt ue-clear">
                	...
                	<span class="optarea">
<!--                         <a href="javascript:;" onclick="add('scheduleManagerController.do?goAdd')" class="add"> -->
<!--                             <i class="icon"></i> -->
<!--                             <span class="text">添加</span> -->
<!--                         </a> -->
<!--                         <a href="javascript:;"  onclick="deleteNewStyleALLSelect('提示','scheduleManagerController.do?doBatchDel','')" class="delete"> -->
<!--                             <i class="icon"></i> -->
...
<%-- 									<td>${resultList.openid}</td> --%>

									<td><t:listDictParse parseId="${resultList.type}" style="1" typecode="RCLX"></t:listDictParse>
									</td>

									<td>${resultList.title}</td>

<%-- 									<td>${resultList.startTime}</td> --%>
...
<%-- 					        <a href="scheduleManagerController.do?goUpdate&id=${resultList.id}" class="tablelink">查看</a>   --%>
					        <a href="javascript:void(0);" onclick="deleteDialog('提示','scheduleManagerController.do?doDel','${resultList.id}')" class="tablelink" > 删除</a>
					        </td>
					      </tr>
					      </c:forEach>
				  ...
				  %>
				    ...
				    <ul class="paginList">
				    			<%
										if(currentPage>1){
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('scheduleManagerController.do?list&str_currentPage=<%=currentPage-1 %>')"  style="width:76px;text-decoration: none;"><span class="pagepre"> < 上一页</span></a></li>
								<%
										}else{
								%>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('scheduleManagerController.do?list&str_currentPage=<%=i+1 %>')"><%=i+1 %></a></li>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('scheduleManagerController.do?list&str_currentPage=<%=currentPage+1 %>')"  style="width:76px;text-decoration: none;"><span class="pagenxt">下一页 > </span></a></li>
								<%
										}else{
								%>
...
<script type="text/javascript">
	...
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'scheduleManagerController.do?upload', "scheduleManagerList");
	}
	
	//导出
	function ExportXls() {
		JeecgExcelExport("scheduleManagerController.do?exportXls","scheduleManagerList");
	}
</script>
</body>
</html>
