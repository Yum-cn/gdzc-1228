...
<form name="form1" id="form1" method="post" action="testdemoController.do?doAdd">
<div class="formbody">
  <div class="formtitle"><span>基本信息</span></div>
  <ul class="forminfo">
    <li>
      <label>姓名:</label>
      	<input id="name" name="name" type="text" type="text" class="dfinput" datatype="*"/>
      <i class="Validform_checktip"></i>
    </li>
    <li>
      <label>单位:</label>
      <t:dictSelect field="unit" typeGroupCode="weixin"></t:dictSelect>
      	<input id="unit" name="unit" type="text" type="text" class="dfinput" datatype="*"/>
      <i class="Validform_checktip"></i>
    </li>
    <li>
      <label>&nbsp;</label>
