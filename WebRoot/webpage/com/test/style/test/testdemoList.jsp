...
<div class="rightinfo">
<form name="searchForm" id="searchForm" method="post" action="testdemoController.do?list">
<div id="container">
	<div id="hd"></div>
    <div id="bd">
    	<div id="main">
            ...
            <div class="table">
            	<div class="opt ue-clear">
                	...
                	<span class="optarea">
                        <a href="javascript:;" onclick="add('testdemoController.do?goAdd')" class="add">
                            <i class="icon"></i>
					  ...
					  <table class="tablelist">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
									...
									<td>${resultList.unit}</td>

					        <td><a href="testdemoController.do?goUpdate&id=${resultList.id}" class="tablelink">修改</a>  <a href="javascript:void(0);" onclick="deleteDialog('提示','testdemoController.do?doDel','${resultList.id}')" class="tablelink" > 删除</a></td>
					      </tr>
					      </c:forEach>
				  ...
				  %>
				    ...
				    <ul class="paginList">
				    			<%
										if(currentPage>1){
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('testdemoController.do?list&str_currentPage=<%=currentPage-1 %>')"  style="width:76px;text-decoration: none;"><span class="pagepre"> < 上一页</span></a></li>
								<%
										}else{
								%>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('testdemoController.do?list&str_currentPage=<%=i+1 %>')"><%=i+1 %></a></li>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('testdemoController.do?list&str_currentPage=<%=currentPage+1 %>')"  style="width:76px;text-decoration: none;"><span class="pagenxt">下一页 > </span></a></li>
								<%
										}else{
								%>
...
<script type="text/javascript">
	...
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'testdemoController.do?upload', "testdemoList");
	}
	
	//导出
	function ExportXls() {
		JeecgExcelExport("testdemoController.do?exportXls","testdemoList");
	}
</script>
</body>
</html>
