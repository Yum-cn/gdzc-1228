...
<div class="rightinfo">
<form name="searchForm" id="searchForm" method="post" action="devnewController.do?list">
<div id="container">
	<div id="hd"></div>
    <div id="bd">
    	<div id="main">
            	...
            	<div class="search-area">
                    <div class="kv-item">
		                        ...
		                        <div class="kv-item-content">
							      	<input id="bpmStatus" name="bpmStatus" type="text" type="text" value="${bpmStatus}"/>
		                        </div>
		                        <label>&nbsp;&nbsp;&nbsp;&nbsp;创建人名称:</label>
		                        <div class="kv-item-content">
		                        ...
		                        <label>&nbsp;&nbsp;&nbsp;&nbsp;创建人登录名称:</label>
		                        <div class="kv-item-content">
							      	<input id="createBy" name="createBy" type="text" type="text" value="${createBy}"/>
		                        </div>
		                        <label>&nbsp;&nbsp;&nbsp;&nbsp;更新人名称:</label>
		                        <div class="kv-item-content">
							      	<input id="updateName" name="updateName" type="text" type="text" value="${updateName}"/>
		                        </div>
                        <div class="kv-item-content">
            ...
            <div class="table">
            	<div class="opt ue-clear">
                	...
                	<span class="optarea">
                        <a href="javascript:;" onclick="add('devnewController.do?goAdd')" class="add">
                            <i class="icon"></i>
					  ...
					  <table class="tablelist">
					    ...
					    <c:forEach items="${resultList}" var="resultList">
					      <tr>
					        ...
					        <td><a href="devnewController.do?goUpdate&id=${resultList.id}" class="tablelink">修改</a>  <a href="javascript:void(0);" onclick="deleteDialog('提示','devnewController.do?doDel','${resultList.id}')" class="tablelink" > 删除</a></td>
					      </tr>
					      </c:forEach>
				  ...
				  %>
				    ...
				    <ul class="paginList">
				    			<%
										if(currentPage>1){
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('devnewController.do?list&str_currentPage=<%=currentPage-1 %>')"  style="width:76px;text-decoration: none;"><span class="pagepre"> < 上一页</span></a></li>
								<%
										}else{
								%>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('devnewController.do?list&str_currentPage=<%=i+1 %>')"><%=i+1 %></a></li>
								...
								%>
								<li class="paginItem"><a href="javascript:void(0);" onclick="onSearchForm('devnewController.do?list&str_currentPage=<%=currentPage+1 %>')"  style="width:76px;text-decoration: none;"><span class="pagenxt">下一页 > </span></a></li>
								<%
										}else{
								%>
...
<script type="text/javascript">
	...
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'devnewController.do?upload', "devnewList");
	}
	
	//导出
	function ExportXls() {
		JeecgExcelExport("devnewController.do?exportXls","devnewList");
	}
</script>
</body>
</html>
