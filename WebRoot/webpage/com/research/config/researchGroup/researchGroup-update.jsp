...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="researchGroupController.do?doUpdate" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="content" name="content">${researchGroupPage.content}</textarea>
							<span class="Validform_checktip"></span>
