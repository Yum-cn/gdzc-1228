		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr height="38px">
						...
						<td class="value" id="research_value">
								...
								1<t:dictSelect field="smallResearch" id="smallResearch" type="list" dictTable="st_research_group_type" dictField="id" dictText="name" hasLabel="false" defaultVal="${applyTopicPage.smallResearch}"></t:dictSelect>
								<span class="Validform_checktip"></span>
