...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="教案管理" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善教案" ></t:dgFunOpt>
 ...
 <script type="text/javascript">
	...
	function plantwindow(id) {
		location.href='lessonPlanController.do?lessonPlan&topId='+id;
// 		$.dialog({
// 			content: 'url:lessonPlanController.do?lessonPlan&topId='+id,
// 			lock : true,
// 			width:800,
// 			height:380,
// 			title:"完善教案管理",
