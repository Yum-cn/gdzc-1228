...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="案例管理" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善案例" ></t:dgFunOpt>
...
// 		$.dialog({
// 			content: 'url:researchCaseController.do?researchCase&topId='+id,
// 			lock : true,
// 			width:800,
// 			height:380,
// 			title:"完善案例",
