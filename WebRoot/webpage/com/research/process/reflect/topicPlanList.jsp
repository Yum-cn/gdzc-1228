...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="教学反思" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善教学反思" ></t:dgFunOpt>
...
// 		$.dialog({
// 			content: 'url:researchReflectController.do?researchReflect&topId='+id,
// 			lock : true,
// 			width:800,
// 			height:380,
// 			title:"完善研究反思",
