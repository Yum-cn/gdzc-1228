...
<%--    <t:dgToolBar title="新增研究反思" icon="icon-add" url="researchReflectController.do?goAdd&topId=${topId }" funname="add"></t:dgToolBar> --%>
<%--    <t:dgToolBar title="编辑研究反思" icon="icon-edit" url="researchReflectController.do?goUpdate" funname="update"></t:dgToolBar> --%>
  </t:datagrid>
  </div>
 </div>
