...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="studyActivityList" checkbox="false" fitColumns="false" title="研究活动管理" actionUrl="studyActivityController.do?datagrid" idField="id" fit="true" queryMode="group">
...
<%--    <t:dgToolBar title="编辑研究活动" icon="icon-edit" url="studyActivityController.do?goUpdate" funname="update"></t:dgToolBar> --%>
 ...
 $(document).ready(function(){
	...
	function addplantwindow(id) {
		$.dialog({
			content: 'url:studyActivityController.do?goView&id='+id,
			lock : true,
			width:800,
			height:380,
			title:"阅读",
