...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="工作计划" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善工作计划" ></t:dgFunOpt>
