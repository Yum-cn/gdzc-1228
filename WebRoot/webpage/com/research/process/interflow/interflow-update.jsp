...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="interflowController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						<input id="hdsj" name="hdsj" type="text" style="width: 150px" class="inputxt" class="Wdate" onClick="WdatePicker()" value="<fmt:formatDate value="${interflowPage.hdsj}" pattern="yyyy-MM-dd"/>">
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="content" name="content" cols="50" rows="16">${interflowPage.content}</textarea>
							<span class="Validform_checktip"></span>
