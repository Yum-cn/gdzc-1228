  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="learningRecordController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="lecture" name="lecture" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${learningRecordPage.lecture}'>
						...
						<td class="value">
									  <input id="lectureDate" name="lectureDate" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${learningRecordPage.lectureDate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="feel" name="feel" cols="50" rows="16">${learningRecordPage.feel}</textarea>
							<span class="Validform_checktip"></span>
