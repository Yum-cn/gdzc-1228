...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="活动管理" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善活动" ></t:dgFunOpt>
...
// 		$.dialog({
// 			content: 'url:researchActivityController.do?researchActivity&topId='+id,
// 			lock : true,
// 			width:800,
// 			height:380,
// 			title:"完善活动",
