...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="researchActivityController.do?doAdd" tiptype="1">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="activitiesDate" name="activitiesDate" type="text" style="width: 150px" class="inputxt"  class="Wdate" onClick="WdatePicker()">
				...
				<tr>
					...
					<td class="value">
							<textarea name="advantage" id="advantage" style="width:92%;height:60px;"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							...
							<textarea name="problem" id="problem" style="width:92%;height:60px;"></textarea>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							<textarea name="reflect" id="reflect" style="width:92%;height:60px;"></textarea>
							<span class="Validform_checktip"></span>
