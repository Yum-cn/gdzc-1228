...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="certificateRegisterList2" checkbox="false" fitColumns="false" title="" actionUrl="certificateRegisterController.do?datagrid&funType=3" idField="id" fit="true" queryMode="group">
...
<%--    <t:dgCol title="创建单位"  field="createOrg"  hidden="true"  queryMode="single"  width="120"></t:dgCol> --%>
   ...
   <t:dgDelOpt title="删除" url="certificateRegisterController.do?doDel&id={id}" exp="stauts#eq#3"/>
      ...
      <t:dgToolBar title="登记证书" icon="icon-add" url="certificateRegisterController.do?goAdd&funType=3" funname="add"></t:dgToolBar>
