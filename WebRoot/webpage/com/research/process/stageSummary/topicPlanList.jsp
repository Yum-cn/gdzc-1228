...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="阶段性总结" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善阶段性总结" ></t:dgFunOpt>
...
// 		$.dialog({
// 			content: 'url:stageSummaryController.do?stageSummary&topId='+id,
// 			lock : true,
// 			width:800,
// 			height:380,
// 			title:"完善阶段性总结",
