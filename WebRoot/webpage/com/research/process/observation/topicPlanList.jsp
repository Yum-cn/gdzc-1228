...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="研究记录" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善研究记录" ></t:dgFunOpt>
 ...
 <script type="text/javascript">
	...
	function plantwindow(id) {
		location.href='observationRecordController.do?observationRecord&topId='+id;
// 		$.dialog({
// 			content: 'url:seeResourcesController.do?seeResources&topId='+id,
// 			lock : true,
// 			width:800,
// 			height:380,
// 			title:"完善参阅资料",
