...
<%--    <t:dgToolBar title="录入观察记录" icon="icon-add" url="observationRecordController.do?goAdd&topId=${topId }" funname="add"></t:dgToolBar> --%>
<%--    <t:dgToolBar title="编辑观察记录" icon="icon-edit" url="observationRecordController.do?goUpdate" funname="update"></t:dgToolBar> --%>
