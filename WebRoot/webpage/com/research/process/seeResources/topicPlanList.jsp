...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="参阅资料" actionUrl="applyTopicController.do?researchDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善参阅资料" ></t:dgFunOpt>
 ...
 <script type="text/javascript">
	...
	function plantwindow(id) {
		location.href='seeResourcesController.do?seeResourcesMain&topId='+id;
// 		$.dialog({
