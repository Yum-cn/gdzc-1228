...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="seeResourcesController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	<input id="noteDate" name="noteDate" type="text" style="width: 150px" class="inputxt" class="Wdate" onClick="WdatePicker()">
				...
				<tr>
					...
					<td class="value">
							<input type="radio" name="type" id="type" value="0" checked="checked"/>书籍
							<input type="radio" name="type" id="type" value="1"/>网络
							<span class="Validform_checktip"></span>
