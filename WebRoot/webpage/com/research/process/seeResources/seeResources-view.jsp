  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="seeResourcesController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value"><fmt:formatDate value="${seeResourcesPage.noteDate}" pattern="yyyy-MM-dd"/>           
					...
					<tr>
						...
						<td class="value">${seeResourcesPage.title}
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">${seeResourcesPage.author}
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">${seeResourcesPage.source}
							<span class="Validform_checktip"></span>
