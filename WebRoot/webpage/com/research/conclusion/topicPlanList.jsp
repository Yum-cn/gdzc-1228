...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="applyTopicList" checkbox="false" fitColumns="false" title="成果申报" actionUrl="applyTopicController.do?conclusionDatagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt funname="plantwindow(id)" title="完善结题申请表" exp="status#eq#3"></t:dgFunOpt>
   <t:dgFunOpt funname="confirmAudit(id)" title="提交结题审核" exp="status#eq#3"></t:dgFunOpt>
  </t:datagrid>
  </div>
 </div>
 ...
 <script type="text/javascript">
	...
	function plantwindow(id) {
		$.dialog({
			content: 'url:conclusionController.do?goAdd&topId='+id,
			lock : true,
			width:800,
			height:380,
			title:"结题申请表",
