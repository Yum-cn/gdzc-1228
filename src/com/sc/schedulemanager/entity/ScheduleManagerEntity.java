package com.sc.schedulemanager.entity;
 ...
 */
@Entity
@Table(name = "sc_schedule_manager", schema = "")
@SuppressWarnings("serial")
public class ScheduleManagerEntity implements java.io.Serializable {
	/**主键*/
