package com.sc.schedulemanager.service.impl;
...
@Transactional
public class ScheduleManagerServiceImpl extends CommonServiceImpl implements ScheduleManagerServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ScheduleManagerEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ScheduleManagerEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ScheduleManagerEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ScheduleManagerEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ScheduleManagerEntity t){
