package com.survey.test.service.impl;
...
@Transactional
public class DevTestServiceImpl extends CommonServiceImpl implements DevTestServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DevTestEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DevTestEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DevTestEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DevTestEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DevTestEntity t){
