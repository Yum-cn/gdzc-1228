package com.document.doclogincount.service.impl;
...
@Service("docLoginCountService")
@Transactional
public class DocLoginCountServiceImpl extends CommonServiceImpl implements DocLoginCountServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DocLoginCountEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DocLoginCountEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DocLoginCountEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DocLoginCountEntity t){
		...
		map.put("login_date", t.getLoginDate());
		map.put("login_count", t.getLoginCount());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DocLoginCountEntity t){
 		...
 		sql  = sql.replace("#{login_count}",String.valueOf(t.getLoginCount()));
