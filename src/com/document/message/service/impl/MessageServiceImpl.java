package com.document.message.service.impl;
...
public class MessageServiceImpl extends CommonServiceImpl implements MessageServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(MessageEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(MessageEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(MessageEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(MessageEntity t){
		...
		map.put("document_id", t.getDocumentId());
		map.put("send_user", t.getSendUser());
		map.put("receive_user", t.getReceiveUser());
		return map;
	}
	 ...
	 */
 	public String replaceVal(String sql,MessageEntity t){
 		...
 		sql  = sql.replace("#{document_id}",String.valueOf(t.getDocumentId()));
 		sql  = sql.replace("#{send_user}",String.valueOf(t.getSendUser()));
 		sql  = sql.replace("#{receive_user}",String.valueOf(t.getReceiveUser()));
