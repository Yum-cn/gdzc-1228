package com.document.message.entity;
...
public class MessageEntity implements java.io.Serializable {
	...
	/**消息类型*/
	@Excel(name="消息类型")
	private java.lang.String type;//1:协作文档,2:消息文档
	/**文档ID*/
	@Excel(name="文档ID")
	 ...
	 */
	private java.lang.String usePermission;//文档操作权限
	 ...
	 */
	@Column(name ="DOCUMENT_ID",nullable=true,length=32)
	 ...
	 */
	@Column(name ="SEND_USER",nullable=true,length=32)
	 ...
	 */
	@Column(name ="RECEIVE_USER",nullable=true,length=32)
	...
	@Column(name ="send_user_id",nullable=true,length=2000)
	...
	@Column(name ="receive_user_id",nullable=true,length=2000)
	...
	@Column(name ="use_permission",nullable=true,length=20)
	public java.lang.String getUsePermission() {
		return usePermission;
	}

	public void setUsePermission(java.lang.String usePermission) {
