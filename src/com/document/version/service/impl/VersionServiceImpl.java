package com.document.version.service.impl;
...
public class VersionServiceImpl extends CommonServiceImpl implements VersionServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(VersionEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(VersionEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(VersionEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(VersionEntity t){
		...
		map.put("version_number", t.getVersionNumber());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,VersionEntity t){
 		...
 		sql  = sql.replace("#{version_number}",String.valueOf(t.getVersionNumber()));
