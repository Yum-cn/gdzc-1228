package com.document.version.entity;
...
public class VersionEntity implements java.io.Serializable {
	 ...
	 */
	@Column(name ="DOCUMENT_ID",nullable=true,length=50)
