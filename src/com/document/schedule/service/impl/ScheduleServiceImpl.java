package com.document.schedule.service.impl;
...
@Transactional
public class ScheduleServiceImpl extends CommonServiceImpl implements ScheduleServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ScheduleEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ScheduleEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ScheduleEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ScheduleEntity t){
