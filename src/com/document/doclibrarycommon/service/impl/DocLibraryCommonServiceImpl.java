...
@Service("libCommonFileService")
@Transactional
public class DocLibraryCommonServiceImpl extends CommonServiceImpl implements DocLibraryCommonServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DocLibraryCommonEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DocLibraryCommonEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DocLibraryCommonEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DocLibraryCommonEntity t){
		...
		map.put("file_size", t.getFileSize());
		map.put("file_type", t.getFileType());
		map.put("upload_time", t.getUploadTime());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DocLibraryCommonEntity t){
 		...
 		sql  = sql.replace("#{file_size}",String.valueOf(t.getFileSize()));
 		sql  = sql.replace("#{file_type}",String.valueOf(t.getFileType()));
 		sql  = sql.replace("#{upload_time}",String.valueOf(t.getUploadTime()));
