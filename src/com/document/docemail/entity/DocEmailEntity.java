package com.document.docemail.entity;
 ...
 */
@Entity
@Table(name = "doc_email", schema = "")
@SuppressWarnings("serial")
public class DocEmailEntity implements java.io.Serializable {
	/**主键*/
	...
	/**抄送人*/
	@Excel(name="抄送人")
	private java.lang.String carbonCopy;
	/**标题*/
	@Excel(name="标题")
	 ...
	 */
	@Column(name ="ADDRESSEE",nullable=true,length=32)
	 ...
	 */
	@Column(name ="CARBON_COPY",nullable=true,length=100)
	 ...
	 */
	public void setCarbonCopy(java.lang.String carbonCopy){
	 ...
	 */
	@Column(name ="EMAIL_TITLE",nullable=true,length=200)
	 ...
	 */
	@Column(name ="EMAIL_CONTENT",nullable=true,length=2000)
