package com.document.docmyfile.service.impl;
...
@Service("docMyFileService")
@Transactional
public class DocMyFileServiceImpl extends CommonServiceImpl implements DocMyFileServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DocMyFileEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DocMyFileEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DocMyFileEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DocMyFileEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DocMyFileEntity t){
