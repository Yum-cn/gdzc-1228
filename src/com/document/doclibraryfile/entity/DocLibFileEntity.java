package com.document.doclibraryfile.entity;
 ...
 */
@Entity
@Table(name = "doc_library_file", schema = "")
@SuppressWarnings("serial")
public class DocLibFileEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="P_ID",nullable=true,length=50)
