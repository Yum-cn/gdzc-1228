package com.document.doclibraryfile.service.impl;
...
@Service("docLibFileService")
@Transactional
public class DocLibFileServiceImpl extends CommonServiceImpl implements DocLibFileServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DocLibFileEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DocLibFileEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DocLibFileEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DocLibFileEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DocLibFileEntity t){
