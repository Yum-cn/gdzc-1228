 ...
 * @date 2017-02-13 18:39:56
 * @version V1.0   
 *
 */
@Entity
@Table(name = "doc_notice_count", schema = "")
@SuppressWarnings("serial")
public class DocNoticeCountEntity implements java.io.Serializable {
	/**主键*/
	...
	/**阅读人*/
	@Excel(name="阅读人")
	private java.lang.String reader;
	/**文件夹ID*/
	@Excel(name="通知ID")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  阅读人
	 */
	@Column(name ="READER",nullable=true,length=32)
