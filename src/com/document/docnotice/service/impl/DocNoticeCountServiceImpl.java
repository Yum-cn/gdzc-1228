...
@Service("docNoticeCountService")
@Transactional
public class DocNoticeCountServiceImpl extends CommonServiceImpl implements DocNoticeCountServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DocNoticeCountEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DocNoticeCountEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DocNoticeCountEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DocNoticeCountEntity t){
		...
		map.put("reader", t.getReader());
		map.put("read_date", t.getReadDate());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DocNoticeCountEntity t){
 		...
 		sql  = sql.replace("#{reader}",String.valueOf(t.getReader()));
