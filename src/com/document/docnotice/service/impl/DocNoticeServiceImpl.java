package com.document.docnotice.service.impl;
...
@Transactional
public class DocNoticeServiceImpl extends CommonServiceImpl implements DocNoticeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(DocNoticeEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(DocNoticeEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(DocNoticeEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(DocNoticeEntity t){
		...
		map.put("notice_sender", t.getNoticeSender());
		map.put("notice_audience", t.getNoticeAudience());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DocNoticeEntity t){
 		...
 		sql  = sql.replace("#{notice_sender}",String.valueOf(t.getNoticeSender()));
 		sql  = sql.replace("#{notice_audience}",String.valueOf(t.getNoticeAudience()));
