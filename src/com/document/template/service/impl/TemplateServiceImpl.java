package com.document.template.service.impl;
...
public class TemplateServiceImpl extends CommonServiceImpl implements TemplateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TemplateEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TemplateEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TemplateEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TemplateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TemplateEntity t){
 		...
 		sql  = sql.replace("#{doc_path}",String.valueOf(t.getDocPath()));
