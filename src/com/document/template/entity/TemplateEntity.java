package com.document.template.entity;
 ...
 */
@Entity
@Table(name = "doc_template", schema = "")
...
public class TemplateEntity implements java.io.Serializable {
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  模板文件
	 */
	@Column(name ="DOC_PATH",nullable=true,length=2000)
