 ...
 */
@Entity
@Table(name = "st_study_activity", schema = "")
@SuppressWarnings("serial")
public class StudyActivityEntity implements java.io.Serializable {
	/**主键*/
