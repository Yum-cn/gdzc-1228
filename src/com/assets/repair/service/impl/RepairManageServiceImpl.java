package com.assets.repair.service.impl;
...
@Service("repairManageService")
@Transactional
public class RepairManageServiceImpl extends CommonServiceImpl implements RepairManageServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(RepairManageEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(RepairManageEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(RepairManageEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(RepairManageEntity t){
		...
		map.put("repair_time", t.getRepairTime());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,RepairManageEntity t){
 		...
 		sql  = sql.replace("#{repair_time}",String.valueOf(t.getRepairTime()));
