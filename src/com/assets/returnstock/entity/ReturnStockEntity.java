package com.assets.returnstock.entity;
 ...
 * @date 2018-05-12 11:57:32
 * @version V1.0   
 *
 */
@Entity
@Table(name = "assets_return_stock", schema = "")
@SuppressWarnings("serial")
public class ReturnStockEntity implements java.io.Serializable {
	/**主键*/
	...
	/**退库时间*/
	@Excel(name="退库时间",format = "yyyy-MM-dd")
	private java.util.Date returnStockTime;
	/**备注*/
	@Excel(name="备注")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  存放地点
	 */
	@Column(name ="DEPOSIT_ADDRESS",nullable=true,length=500)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  存放地点
	 */
	public void setDepositAddress(java.lang.String depositAddress){
	 ...
	 */
	@Column(name ="RETURN_STOCK_TIME",nullable=true,length=32)
	public java.util.Date getReturnStockTime(){
		return this.returnStockTime;
	}
	 ...
	 */
	public void setReturnStockTime(java.util.Date returnStockTime){
