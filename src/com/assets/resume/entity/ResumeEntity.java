package com.assets.resume.entity;
 ...
 */
@Entity
@Table(name = "assets_resume", schema = "")
...
public class ResumeEntity implements java.io.Serializable {
	 ...
	 */
	@Column(name ="HANDLE_TIME",nullable=true,length=32)
	 ...
	 */
	@Column(name ="HANDLE_USER",nullable=true,length=32)
