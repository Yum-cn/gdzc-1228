package com.assets.resume.service.impl;
...
@Transactional
public class ResumeServiceImpl extends CommonServiceImpl implements ResumeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ResumeEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ResumeEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ResumeEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ResumeEntity t){
		...
		map.put("handle_time", t.getHandleTime());
		map.put("handle_user", t.getHandleUser());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ResumeEntity t){
 		...
 		sql  = sql.replace("#{handle_time}",String.valueOf(t.getHandleTime()));
 		sql  = sql.replace("#{handle_user}",String.valueOf(t.getHandleUser()));
