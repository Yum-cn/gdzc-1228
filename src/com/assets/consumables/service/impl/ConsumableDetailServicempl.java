package com.assets.consumables.service.impl;
...
@Service("consumableDetailService")
@Transactional
public class ConsumableDetailServicempl extends CommonServiceImpl implements ConsumableDetailService {
	 ...
	 * @return
	 */
	private void doAddBus(ConsumableDetailEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ConsumableDetailEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ConsumableDetailEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ConsumableEntity t){
