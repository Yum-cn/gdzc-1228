...
@Transactional
public class ConsumableServicempl extends CommonServiceImpl implements ConsumableService {
	 ...
	 * @return
	 */
	private void doAddBus(ConsumableEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ConsumableEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ConsumableEntity t) throws Exception{
 	}
