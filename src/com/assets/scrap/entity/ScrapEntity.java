package com.assets.scrap.entity;
 ...
 */
@Entity
@Table(name = "assets_scrap", schema = "")
@SuppressWarnings("serial")
public class ScrapEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  报废时间
	 */
	@Column(name ="SCRAP_TIME",nullable=true,length=32)
