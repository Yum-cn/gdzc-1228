...
public class ReadExcel<T> {
   ...
   * @return
   */
  public List<T> getExcelInfo(String fileName,MultipartFile Mfile){
   ...
   * @throws IOException
   */
  public  List<T> getExcelInfo(InputStream is,boolean isExcel2003){
   ...
   * @return
   */
  private List<T> readExcelValue(Workbook wb){ 
      //得到第一个shell  
