package com.assets.allot.service.impl;
...
@Transactional
public class AllotServiceImpl extends CommonServiceImpl implements AllotServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AllotEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(AllotEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(AllotEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(AllotEntity t){
		...
		map.put("use_user", t.getUseUser());
		map.put("address", t.getAddress());
		map.put("allot_time", t.getAllotTime());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AllotEntity t){
 		...
 		sql  = sql.replace("#{use_user}",String.valueOf(t.getUseUser()));
 		sql  = sql.replace("#{address}",String.valueOf(t.getAddress()));
 		sql  = sql.replace("#{allot_time}",String.valueOf(t.getAllotTime()));
