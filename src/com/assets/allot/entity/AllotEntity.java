package com.assets.allot.entity;
 ...
 */
@Entity
@Table(name = "assets_allot", schema = "")
@SuppressWarnings("serial")
public class AllotEntity implements java.io.Serializable {
	/**主键*/
	...
	/**调拨时间*/
	@Excel(name="转移时间",format = "yyyy-MM-dd")
	 ...
	 */
	@Column(name ="USE_USER",nullable=true,length=50)
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  调拨时间
	 */
	@Column(name ="ALLOT_TIME",nullable=true,length=32)
