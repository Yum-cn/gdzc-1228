 ...
 */
@Entity
@Table(name = "assets_use", schema = "")
@SuppressWarnings("serial")
public class UseEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="USE_TIME",nullable=true,length=32)
