package com.assets.use.service.impl;
...
@Service("useService")
@Transactional
public class UseServiceImpl extends CommonServiceImpl implements UseServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(UseEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(UseEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(UseEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(UseEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,UseEntity t){
