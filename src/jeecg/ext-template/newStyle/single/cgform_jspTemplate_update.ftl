...
<form name="form1" id="form1" method="post" action="${entityName?uncap_first}Controller.do?doUpdate">
			<#list columns as po>
				<#if po.isShow == 'N'>
...
<div class="formbody">
  ...
  <ul class="forminfo">
    ...
    <li>
      ...
      <#if po.showType=='text'>
      	<input id="${po.fieldName}" name="${po.fieldName}" type="text" value="${'$'}{${entityName?uncap_first}Page.${po.fieldName} }" class="dfinput" datatype="*"/>
      <#elseif po.showType=='textarea'>
      	<textarea id="${po.fieldName}" name="${po.fieldName}" cols="" rows="" class="textinput" datatype="*">${'$'}{${entityName?uncap_first}Page.${po.fieldName} }</textarea>
      <#elseif po.showType=='date'>
      	<input id="${po.fieldName}" name="${po.fieldName}" type="text" value="<fmt:formatDate value="${'$'}{${entityName?uncap_first}Page.${po.fieldName} }" pattern="yyyy-MM-dd"/>" class="dfinput" class="Wdate" onClick="WdatePicker()" datatype="*"/>
      <#elseif po.showType=='datetime'>
      	<input id="${po.fieldName}" name="${po.fieldName}" type="text" value="<fmt:formatDate value="${'$'}{${entityName?uncap_first}Page.${po.fieldName} }" pattern="yyyy-MM-dd HH:mm:ss"/>" class="dfinput" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*"/>
