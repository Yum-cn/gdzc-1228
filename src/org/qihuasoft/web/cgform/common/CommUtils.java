package org.qihuasoft.web.cgform.common;
...
public class CommUtils {
    ...
    public static void main(String[] args) {
    	...
    	org.qihuasoft.core.util.LogUtil.info(strs.length+"");
    	org.qihuasoft.core.util.LogUtil.info(strs[0].substring(0,strs[0].indexOf("[")));
	}
}
