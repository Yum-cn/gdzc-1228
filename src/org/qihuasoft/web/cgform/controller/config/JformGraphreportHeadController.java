...
import org.qihuasoft.web.cgform.entity.config.JformGraphreportHeadEntity;
import org.qihuasoft.web.cgform.entity.config.JformGraphreportHeadPage;
import org.qihuasoft.web.cgform.entity.config.JformGraphreportItemEntity;
import org.qihuasoft.web.cgform.service.config.JformGraphreportHeadServiceI;
...
public class JformGraphreportHeadController extends BaseController {
	...
	public void datagrid(JformGraphreportHeadEntity jformGraphreportHead,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, jformGraphreportHead);
		try{
		//自定义追加查询条件
		}catch (Exception e) {
