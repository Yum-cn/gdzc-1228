package  org.qihuasoft.web.cgform.controller.autoform;
...
import org.qihuasoft.web.cgform.entity.autoform.AutoFormDbEntity;
import org.qihuasoft.web.cgform.entity.autoform.AutoFormDbFieldEntity;
import org.qihuasoft.web.cgform.entity.autoform.AutoFormEntity;
import org.qihuasoft.web.cgform.entity.autoform.AutoFormParamEntity;
import org.qihuasoft.web.cgform.entity.autoform.AutoFormStyleEntity;
import org.qihuasoft.web.cgform.service.autoform.AutoFormDbServiceI;
import org.qihuasoft.web.cgform.service.autoform.AutoFormServiceI;
import org.qihuasoft.web.cgform.util.AutoFormCommUtil;
import org.qihuasoft.web.cgform.util.AutoFormTemplateParseUtil;
...
public class AutoFormController extends BaseController {
	...
	public void datagrid(AutoFormEntity autoForm,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, autoForm, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
