...
import org.qihuasoft.web.cgform.service.autoform.AutoFormStyleServiceI;
...
public class AutoFormStyleController extends BaseController {
	...
	public void datagrid(AutoFormStyleEntity autoFormStyle,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, autoFormStyle, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
