package org.qihuasoft.web.system.sms.controller;
...
import org.qihuasoft.web.system.sms.util.TuiSongMsgUtil;
...
public class TSSmsTemplateSqlController extends BaseController {
	...
	public void datagrid(TSSmsTemplateSqlEntity tSSmsTemplateSql,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsTemplateSql, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
