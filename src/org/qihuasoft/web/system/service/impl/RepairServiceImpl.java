...
import org.qihuasoft.web.cgform.engine.FreemarkerHelper;
...
//import org.qihuasoft.web.demo.entity.test.CKEditorEntity;
//import org.qihuasoft.web.demo.entity.test.CourseEntity;
//import org.qihuasoft.web.demo.entity.test.JeecgDemoCkfinderEntity;
//import org.qihuasoft.web.demo.entity.test.JeecgJdbcEntity;
//import org.qihuasoft.web.demo.entity.test.JeecgMatterBom;
//import org.qihuasoft.web.demo.entity.test.JeecgNoteEntity;
//import org.qihuasoft.web.demo.entity.test.JeecgOrderCustomEntity;
//import org.qihuasoft.web.demo.entity.test.JeecgOrderMainEntity;
//import org.qihuasoft.web.demo.entity.test.JeecgOrderProductEntity;
//import org.qihuasoft.web.demo.entity.test.StudentEntity;
//import org.qihuasoft.web.demo.entity.test.TSStudent;
//import org.qihuasoft.web.demo.entity.test.TeacherEntity;
import org.qihuasoft.web.system.dao.repair.RepairDao;
import org.qihuasoft.web.system.pojo.base.*;
import org.qihuasoft.web.system.service.RepairService;
...
//		commonDao.saveOrUpdate(ckEditor);
	...
	private void repairDemo() {
		...
		// 复杂字符串文本读取，采用文件方式存储
		String html = new FreemarkerHelper().parseTemplate("/org/qihuasoft/web/system/txt/valid-code-demo.ftl", null);
...
//		approver.setTSDepart(eiu);
	...
	private void repaireIcon() {
		org.qihuasoft.core.util.LogUtil.info("修复图标中");
	...
	private void repairMenu() {
		...
		TSIcon folder = commonDao.findByProperty(TSIcon.class, "iconName",
				"文件夹").get(0);
		org.qihuasoft.core.util.LogUtil.info(defaultIcon.getIconPath());
