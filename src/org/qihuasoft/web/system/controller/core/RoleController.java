...
import org.qihuasoft.web.system.pojo.base.TSDataRule;
...
import org.qihuasoft.web.system.pojo.base.TSRoleOrg;
...
public class RoleController extends BaseController {
	...
	public void roleGrid(TSRole role, HttpServletRequest request,
		...
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq,
				role);
		cq.add();
	...
	public AjaxJson updateAuthority(HttpServletRequest request) {
		...
		try {
			...
			System.out.println(roleFunctions.toString());
...
//      systemService.addLog(message, Globals.Log_Type_UPDATE, Globals.Log_Leavel_INFO);
	...
	public String exportXls(TSRole tsRole,HttpServletRequest request,HttpServletResponse response
		...
		CriteriaQuery cq = new CriteriaQuery(TSRole.class, dataGrid);
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tsRole, request.getParameterMap());
