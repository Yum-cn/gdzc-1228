...
import org.qihuasoft.web.system.pojo.base.TSNoticeAuthorityRole;
import org.qihuasoft.web.system.service.NoticeAuthorityRoleServiceI;
...
public class NoticeAuthorityRoleController extends BaseController {
	...
	public void datagrid(TSNoticeAuthorityRole noticeAuthorityRole,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, noticeAuthorityRole, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
