...
import org.qihuasoft.core.timer.DynamicTask;
...
import org.qihuasoft.web.system.pojo.base.TSTimeTaskEntity;
...
public class TimeTaskController extends BaseController {
	...
	public void datagrid(TSTimeTaskEntity timeTask,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, timeTask, request.getParameterMap());
