...
import org.qihuasoft.web.system.pojo.base.MutiLangEntity;
...
public class MutiLangController extends BaseController {
	...
	public void datagrid(MutiLangEntity mutiLang, HttpServletRequest request,
		...
		// 查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, mutiLang, request.getParameterMap());
