...
import org.qihuasoft.core.common.dao.jdbc.JdbcDao;
...
import org.qihuasoft.core.common.model.json.ComboTree;
import org.qihuasoft.core.common.model.json.DataGrid;
import org.qihuasoft.core.common.model.json.TreeGrid;
import org.qihuasoft.core.common.model.json.ValidForm;
import org.qihuasoft.core.constant.Globals;
import org.qihuasoft.core.extend.hqlsearch.parse.ObjectParseUtil;
import org.qihuasoft.core.extend.hqlsearch.parse.PageValueConvertRuleEnum;
import org.qihuasoft.core.extend.hqlsearch.parse.vo.HqlRuleEnum;
import org.qihuasoft.core.util.DateUtils;
import org.qihuasoft.core.util.JSONHelper;
import org.qihuasoft.core.util.ListUtils;
import org.qihuasoft.core.util.MutiLangSqlCriteriaUtil;
...
import org.qihuasoft.core.util.YouBianCodeUtil;
import org.qihuasoft.core.util.oConvertUtils;
import org.qihuasoft.tag.core.easyui.TagUtil;
import org.qihuasoft.tag.vo.easyui.ComboTreeModel;
import org.qihuasoft.tag.vo.easyui.TreeGridModel;
import org.qihuasoft.web.system.manager.ClientManager;
import org.qihuasoft.web.system.manager.ClientSort;
import org.qihuasoft.web.system.pojo.base.Client;
import org.qihuasoft.web.system.pojo.base.DataLogDiff;
import org.qihuasoft.web.system.pojo.base.TSDatalogEntity;
...
import org.qihuasoft.web.system.pojo.base.TSTypegroup;
import org.qihuasoft.web.system.pojo.base.TSVersion;
...
public class SystemController extends BaseController {
	...
	@RequestMapping(params = "indicatorlibrary")
	public ModelAndView indicatorlibrary(HttpServletRequest request) {
		return new ModelAndView("system/type/indicatorlibrary");
	}
	/**
	 * 类型字典列表页面跳转
	 *
...
//        add-start--Author:zhangguoming  Date:20140929 for：多语言条件添加
        ...
        String typeGroupId = request.getParameter("typeGroupId");
        if(typeGroupId!=null && !"".equals(typeGroupId)){
			cq.eq("id", typeGroupId);
			cq.add();
        }
...
//			depart.setOrgCode(orgCode);
    ...
    public void dataLogDatagrid(TSDatalogEntity datalogEntity,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid){
		...
		//查询条件组装器
		org.qihuasoft.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, datalogEntity, request.getParameterMap());
		cq.add();
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
    }
