...
/*//			update-start--Author:longjb  Date:20150408 for：手动设置指定属性主题优先
			...
			if(lang==null || "".equals(lang)){
				langjs = "<script type=\"text/javascript\" src=\"plug-in/mutiLang/zh-cn.js\"></script>";
			}else{
				langjs = StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/mutiLang/{0}.js\"></script>", "{0}", lang);
			}
			sb.append(langjs);
...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
				...
				if(lang==null || "".equals(lang)){
					sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/curdtools_zh-cn.js\"></script>");
				}else{
