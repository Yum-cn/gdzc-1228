...
import org.qihuasoft.tag.vo.easyui.ColumnValue;
import org.qihuasoft.tag.vo.easyui.DataGridColumn;
import org.qihuasoft.tag.vo.easyui.DataGridUrl;
import org.qihuasoft.tag.vo.easyui.OptTypeDirection;
...
public class DataGridTag extends TagSupport {
	...
	public int doEndTag() throws JspException {
		JspWriter out = null;
		try {
			if(langArg!=null && !"".equals(langArg))
	...
	protected void getOptUrl(StringBuffer sb) {
		...
		for (DataGridUrl dataGridUrl : list) {
			...
			if (OptTypeDirection.OpenTab.equals(dataGridUrl.getType())) {
				...
				sb.append("href+=\"[<a href=\'#\' onclick=\"location.href='" + dataGridUrl.getTitle() + "';\">\";");
			}
