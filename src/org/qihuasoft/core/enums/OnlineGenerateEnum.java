package org.qihuasoft.core.enums;
...
public enum OnlineGenerateEnum {
	...
	//
	ONLINE_04("03","Table风格(form)","onetomany", "system"),
	ONLINE_07("06","bootstrap风格(form)","onetomany","system"),
	
	ONLINE_02("01","Table风格(form)","single", "system"),
	ONLINE_03("02","Div风格(form)","single", "system"),
	ONLINE_05("04","自定义word(form)","single", "system"),
	ONLINE_06("05","bootstrap风格(form)","single", "system"),
	/*ONLINE_07("07","nopopform风格","single","system"),*/
	ONLINE_NOPOP_SINGLE("nopop.single","nopopform风格","single","ext"),
	ONLINE_01("newStyle.single","newStyle风格","single","ext"),
