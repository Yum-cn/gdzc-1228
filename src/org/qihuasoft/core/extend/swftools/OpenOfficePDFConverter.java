package org.qihuasoft.core.extend.swftools;
...
//		}
		...
		//pdfFile = pdfFile.replaceAll(" ", "").replaceAll("　", "");
		 org.qihuasoft.core.util.LogUtil.info("进行文档转换转换:" + inputFile + " --> " + pdfFile);
		...
		try {
			...
			org.qihuasoft.core.util.LogUtil.info(e.getMessage());
		}
		
		stopService();
	    org.qihuasoft.core.util.LogUtil.info("进行文档转换转换---- 结束----");
	}
	...
	public static void startService() {
		...
		try {
			...
			org.qihuasoft.core.util.LogUtil.info("office转换服务启动成功!");
		} catch (Exception ce) {
			org.qihuasoft.core.util.LogUtil.info("office转换服务启动失败!详细信息:" + ce);
		}
	}

	public static void stopService() {
		org.qihuasoft.core.util.LogUtil.info("关闭office转换服务....");
		if (officeManager != null) {
			officeManager.stop();
		}
		org.qihuasoft.core.util.LogUtil.info("关闭office转换成功!");
	}
}
