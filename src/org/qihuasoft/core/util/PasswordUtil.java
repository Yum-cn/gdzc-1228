...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		String str = "admin";
		String password = "c44b01947c9e6e3f";

		org.qihuasoft.core.util.LogUtil.info("明文:" + str);
		org.qihuasoft.core.util.LogUtil.info("密码:" + password);

		try {
			byte[] salt = PasswordUtil.getStaticSalt();
			String ciphertext = PasswordUtil.encrypt(str, password, salt);
			org.qihuasoft.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			org.qihuasoft.core.util.LogUtil.info("明文:" + plaintext);
			
			String result = PasswordUtil.decrypt("c44b01947c9e6e3f", "admin", salt);
			org.qihuasoft.core.util.LogUtil.info("明文:" + result);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
