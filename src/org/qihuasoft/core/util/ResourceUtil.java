...
public class ResourceUtil {
	...
	private static final ResourceBundle bundle = java.util.ResourceBundle.getBundle("config/system_config");
	
	/**
	 * 属性文件[resources/config/system_config.properties]
...
//---author:jg_xugj----start-----date:20151226--------for：修改bug 1、key.contains("${")  应改为 key.contains("#{") 2、StringUtil.isEmpty(key) 判断 不为空
	...
	public static void main(String[] args) {
		org.qihuasoft.core.util.LogUtil.info(getPorjectPath());
		org.qihuasoft.core.util.LogUtil.info(getSysPath());
	}
