package org.qihuasoft.core.common.dao.impl;
...
import org.qihuasoft.core.annotation.JeecgEntityTitle;
import org.qihuasoft.core.common.dao.IGenericBaseCommonDao;
...
import org.qihuasoft.core.common.hibernate.qbc.DetachedCriteriaUtil;
import org.qihuasoft.core.common.hibernate.qbc.HqlQuery;
import org.qihuasoft.core.common.hibernate.qbc.PageList;
import org.qihuasoft.core.common.hibernate.qbc.PagerUtil;
...
import org.qihuasoft.core.util.ToEntityUtil;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	...
	private <T> void getProperty(Class entityName) {
		...
		for (int i = 0; i < str.length; i++) {
			...
			org.qihuasoft.core.util.LogUtil.info(property + "---&gt;" + type);
		}
	}
